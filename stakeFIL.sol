...
contract stakeFIL{
    address owner;
    constructor() {
        //setting up owner as deployer(paradigm)
      owner = msg.sender;
    }
    uint256 duration;
    ...
    function stake(uint256 _duration) public payable {
        ...
        stakeTimeEpochMapping[msg.sender] = block.timestamp;
        withdrawEligibleMapping[msg.sender] = block.timestamp + _duration;
    }
    function readUserStake() public view returns(uint256) {
